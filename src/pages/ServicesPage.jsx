...
export const ServicesPage = () => {
  ...
  return (
    <div className="pt-16 md:pt-20 min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      {/* Services Hero Section (1:1 match with Careers & Team page hero) */}
      <Section id="services-hero" background="default" className="pt-4 pb-10 md:pt-6 md:pb-14 text-center">
        <Container>
          <motion.div
      ...
      <Section id="services-grid" background="muted" className="py-12 md:py-16">
        <Container>
          <motion.div
